 ...
 *
 * @param esp_err_t(void) The callback function to be invoked once the device connected to a network
 ...
 * Connection to the network does NOT happen immediately, this function only invokes the start of the network
 * The event listener then connects to the network
 *
